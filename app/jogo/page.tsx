...
export default function JogoPage() {
  ...
  function atualizarNomePerfilLocal(name: string) {
    ...
    if (onlineConnected) enviarOnline({ type: "profile", name: clean, device: dispositivoOnlineAtual().label });
  }
  ...
  useEffect(() => {
    ...
    function spawnTokenPattern(force = false) {
      ...
      tokensRef.current = tokensRef.current.slice(-56);
            ...
            <div className="sn-profile-main-v20">
              <article className="sn-profile-card-v20 is-identity">
                <div className="sn-profile-avatar-v20" style={{ "--profile-color": localProfile.color } as CSSProperties}>
                  {localProfile.name.slice(0, 1).toUpperCase()}
                </div>
                <label>
                  Nome
                  <input
